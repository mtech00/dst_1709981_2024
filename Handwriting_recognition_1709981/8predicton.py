...
data_x=input("introduza valores do handwriting\n")
data=data_x.split(";")
print(data)
...
data1 = pd.read_csv("./dataset_texto/dataset_finalrealdata_handwriting_48.png.csv",sep=";")
...
data_evaluation = pd.read_csv("../out.csv",sep=";")
loaded_model = pickle.load(open('../handwriting_predictor_model', 'rb'))
print("Coefficients: \n", loaded_model.coef_)
